<?php
// URL de la API
$apiUrl = "http://127.0.0.1:8082/facturas";
...
<body>
            ...
            const contenedor = document.getElementById('contenedor-caracteristicas');
             ...
             caracteristicas.forEach(item => {
                ...
                card.innerHTML = `
                    ...
                    <p><strong>Fecha emision:</strong> ${item.fecha_emision}</p>
                    <p><strong>SubTotal:</strong> ${item.subtotal}</p>
                    <p><strong>Impuestos:</strong> ${item.impuestos}</p>
                    <p><strong>Total:</strong> ${item.total}</p>
                    <p><strong>Estado de Pago:</strong> ${item.estado_pago}</p>
    ...
    <div class="imagen-abuelo">
        <img src="./style/facturas.png" alt="Taza de cafe">
    </div>
