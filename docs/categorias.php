<?php
// URL de la API
$apiUrl = "http://127.0.0.1:8082/categorias";
...
<body>
    ...
    <?php else: ?>
        ...
        <script>
            ...
            caracteristicas.forEach(item => {
                ...
                card.innerHTML = `<h2>${item.nombre}</h2><p>${item.descripcion}</p>`;
    ...
    <div class="imagen-abuelo">
        <img src="./style/categorias.png" alt="Abuelo con café diciendo categorias">
    </div>
